...
// Package layertypes represents the imported interface "wavs:worker/layer-types@0.4.0-alpha.2".
package layertypes
...
// Timestamp represents the record "wavs:worker/layer-types@0.4.0-alpha.2#timestamp".
//
//	record timestamp {
//		nanos: u64,
//	}
...
// CosmosAddress represents the record "wavs:worker/layer-types@0.4.0-alpha.2#cosmos-address".
//
...
// CosmosEvent represents the record "wavs:worker/layer-types@0.4.0-alpha.2#cosmos-event".
//
//	record cosmos-event {
//		ty: string,
...
// CosmosChainConfig represents the record "wavs:worker/layer-types@0.4.0-alpha.2#cosmos-chain-config".
//
...
// EthAddress represents the record "wavs:worker/layer-types@0.4.0-alpha.2#eth-address".
//
//	record eth-address {
//		raw-bytes: list<u8>,
//	}
...
// EthEventLogData represents the record "wavs:worker/layer-types@0.4.0-alpha.2#eth-event-log-data".
//
...
// EthChainConfig represents the record "wavs:worker/layer-types@0.4.0-alpha.2#eth-chain-config".
//
...
// TriggerSourceEthContractEvent represents the record "wavs:worker/layer-types@0.4.0-alpha.2#trigger-source-eth-contract-event".
//
...
// TriggerSourceCosmosContractEvent represents the record "wavs:worker/layer-types@0.4.0-alpha.2#trigger-source-cosmos-contract-event".
//
...
// BlockIntervalSource represents the record "wavs:worker/layer-types@0.4.0-alpha.2#block-interval-source".
//
...
// TriggerSourceCron represents the record "wavs:worker/layer-types@0.4.0-alpha.2#trigger-source-cron".
//
...
// TriggerSource represents the variant "wavs:worker/layer-types@0.4.0-alpha.2#trigger-source".
//
...
//		manual,
//	}
type TriggerSource cm.Variant[uint8, TriggerSourceCronShape, TriggerSourceCron]
...
// TriggerConfig represents the record "wavs:worker/layer-types@0.4.0-alpha.2#trigger-config".
//
...
// TriggerDataEthContractEvent represents the record "wavs:worker/layer-types@0.4.0-alpha.2#trigger-data-eth-contract-event".
//
...
// TriggerDataCosmosContractEvent represents the record "wavs:worker/layer-types@0.4.0-alpha.2#trigger-data-cosmos-contract-event".
//
...
// BlockIntervalData represents the record "wavs:worker/layer-types@0.4.0-alpha.2#block-interval-data".
//
...
// TriggerDataCron represents the record "wavs:worker/layer-types@0.4.0-alpha.2#trigger-data-cron".
//
...
// TriggerData represents the variant "wavs:worker/layer-types@0.4.0-alpha.2#trigger-data".
//
...
// TriggerAction represents the record "wavs:worker/layer-types@0.4.0-alpha.2#trigger-action".
//
...
// WasmResponse represents the record "wavs:worker/layer-types@0.4.0-alpha.2#wasm-response".
//
...
// LogLevel represents the variant "wavs:worker/layer-types@0.4.0-alpha.2#log-level".
//
//	variant log-level {
//		error,
//		warn,
