...
// Package layertypes represents the imported interface "wavs:worker/layer-types@0.3.0".
package layertypes
...
// CosmosAddress represents the record "wavs:worker/layer-types@0.3.0#cosmos-address".
//
...
// CosmosEvent represents the record "wavs:worker/layer-types@0.3.0#cosmos-event".
//
//	record cosmos-event {
//		ty: string,
...
// CosmosChainConfig represents the record "wavs:worker/layer-types@0.3.0#cosmos-chain-config".
//
...
// EthAddress represents the record "wavs:worker/layer-types@0.3.0#eth-address".
//
//	record eth-address {
//		raw-bytes: list<u8>,
//	}
...
// EthEventLogData represents the record "wavs:worker/layer-types@0.3.0#eth-event-log-data".
//
...
// EthChainConfig represents the record "wavs:worker/layer-types@0.3.0#eth-chain-config".
//
...
// TriggerSourceEthContractEvent represents the record "wavs:worker/layer-types@0.3.0#trigger-source-eth-contract-event".
//
...
// TriggerSourceCosmosContractEvent represents the record "wavs:worker/layer-types@0.3.0#trigger-source-cosmos-contract-event".
//
...
// BlockIntervalSource represents the record "wavs:worker/layer-types@0.3.0#block-interval-source".
//
...
// TriggerSource represents the variant "wavs:worker/layer-types@0.3.0#trigger-source".
//
...
var _TriggerSourceStrings = [4]string{
	"eth-contract-event",
...
// TriggerConfig represents the record "wavs:worker/layer-types@0.3.0#trigger-config".
//
...
// TriggerDataEthContractEvent represents the record "wavs:worker/layer-types@0.3.0#trigger-data-eth-contract-event".
//
...
// TriggerDataCosmosContractEvent represents the record "wavs:worker/layer-types@0.3.0#trigger-data-cosmos-contract-event".
//
...
// BlockIntervalData represents the record "wavs:worker/layer-types@0.3.0#block-interval-data".
//
...
// TriggerData represents the variant "wavs:worker/layer-types@0.3.0#trigger-data".
//
...
var _TriggerDataStrings = [4]string{
	"eth-contract-event",
	"cosmos-contract-event",
	"block-interval",
	"raw",
...
// TriggerAction represents the record "wavs:worker/layer-types@0.3.0#trigger-action".
//
...
// LogLevel represents the variant "wavs:worker/layer-types@0.3.0#log-level".
//
//	variant log-level {
//		error,
//		warn,
